...
// N
	...
	/** PDC Payable = PDP */
	public static final String DOCBASETYPE_PDCPayable = "PDP";
	/** PDC Receivable = PDR */
	public static final String DOCBASETYPE_PDCReceivable = "PDR";
	/** Profit & Loss Closing = PLC */
	public static final String DOCBASETYPE_ProfitLossClosing = "PLC";
	...
	/** Set Is DirectInvoice.
		@param IsDirectInvoice Is DirectInvoice	  */
	public void setIsDirectInvoice (boolean IsDirectInvoice)
	{
		set_Value (COLUMNNAME_IsDirectInvoice, Boolean.valueOf(IsDirectInvoice));
	}

	/** Get Is DirectInvoice.
		@return Is DirectInvoice	  */
	public boolean isDirectInvoice () 
	{
		Object oo = get_Value(COLUMNNAME_IsDirectInvoice);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
