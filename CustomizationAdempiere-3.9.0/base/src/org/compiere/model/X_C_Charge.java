...
// N
	...
	/** Set Advance Charge.
		@param IsAdvanceCharge 
		This is new field to apply the condition
	  */
	public void setIsAdvanceCharge (boolean IsAdvanceCharge)
	{
		set_Value (COLUMNNAME_IsAdvanceCharge, Boolean.valueOf(IsAdvanceCharge));
	}

	/** Get Advance Charge.
		@return This is new field to apply the condition
	  */
	public boolean isAdvanceCharge () 
	{
		Object oo = get_Value(COLUMNNAME_IsAdvanceCharge);
		if (oo != null) 
		{
