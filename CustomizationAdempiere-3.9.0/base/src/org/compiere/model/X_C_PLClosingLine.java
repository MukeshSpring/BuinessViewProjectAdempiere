...
/** Generated Model for C_PLClosingLine
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_C_PLClosingLine extends PO implements I_C_PLClosingLine, I_Persistent 
{
    ...
    public X_C_PLClosingLine (Properties ctx, int C_PLClosingLine_ID, String trxName)
    {
      super (ctx, C_PLClosingLine_ID, trxName);
      /** if (C_PLClosingLine_ID == 0)
        {
			setC_PLClosingLine_ID (0);
			setC_PLClosing_ID (0);
        } */
    }

    /** Load Constructor */
    public X_C_PLClosingLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_PLClosingLine[")
    ...
    {
        return new KeyNamePair(get_ID(), String.valueOf(getAmtAcctCr()));
    }
	...
	/** Set Closing Lines ID.
		@param C_PLClosingLine_ID Closing Lines ID	  */
	public void setC_PLClosingLine_ID (int C_PLClosingLine_ID)
	{
		if (C_PLClosingLine_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_PLClosingLine_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_PLClosingLine_ID, Integer.valueOf(C_PLClosingLine_ID));
	}

	/** Get Closing Lines ID.
		@return Closing Lines ID	  */
	public int getC_PLClosingLine_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_PLClosingLine_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
		return (I_C_PLClosing)MTable.get(getCtx(), I_C_PLClosing.Table_Name)
			.getPO(getC_PLClosing_ID(), get_TrxName());	}

	/** Set P&L Closing.
		@param C_PLClosing_ID P&L Closing	  */
	...
	{
		set_Value (COLUMNNAME_LedgerCode, LedgerCode);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_LedgerCode);
	}
	...
	{
		set_Value (COLUMNNAME_LedgerName, LedgerName);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_LedgerName);
	}
