...
public class X_M_CostElement extends PO implements I_M_CostElement, I_Persistent 
{
	...
	/** Weighted Avarage Invoice = M */
	public static final String COSTINGMETHOD_WeightedAvarageInvoice = "M";
	/** Weighted Avarage PO = N */
	public static final String COSTINGMETHOD_WeightedAvaragePO = "N";
	/** Cost Combination = O */
	public static final String COSTINGMETHOD_CostCombination = "O";
	/** Set Costing Method.
		@param CostingMethod 
