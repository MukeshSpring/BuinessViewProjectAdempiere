...
public class X_M_Warehouse extends PO implements I_M_Warehouse, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20180805L;
...
// *
	...
	/** Set Positive Stock.
		@param IsPositiveStock 
		New functionality added by business View
	  */
	public void setIsPositiveStock (boolean IsPositiveStock)
	{
		set_Value (COLUMNNAME_IsPositiveStock, Boolean.valueOf(IsPositiveStock));
	}

	/** Get Positive Stock.
		@return New functionality added by business View
	  */
	public boolean isPositiveStock () 
	{
		Object oo = get_Value(COLUMNNAME_IsPositiveStock);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
