...
public class X_C_CashLine extends PO implements I_C_CashLine, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20180729L;
...
// @SQL=SELECT COALESCE(MAX(Line),0)+10 AS DefaultValue FROM C_CashLine WHERE C_Cash_ID=@C_Cash_ID@
	...
	/** CashBook Transfer = CB */
	public static final String CASHTYPE_CashBookTransfer = "CB";
	/** Cash Received From = CR */
	public static final String CASHTYPE_CashReceivedFrom = "CR";
	/** Set Cash Type.
		@param CashType 
		Source of Cash
	  */
