...
public class X_C_PaymentAllocate extends PO implements I_C_PaymentAllocate, I_Persistent 
{
	...
	/** allocateType AD_Reference_ID=1000009 */
	public static final int ALLOCATETYPE_AD_Reference_ID=1000009;
	/** Charge = C */
	public static final String ALLOCATETYPE_Charge = "C";
	/** Invoice = I */
	public static final String ALLOCATETYPE_Invoice = "I";
	/** Set AllocateType.
		@param allocateType 
		This is new field to apply charges and invoice at allocate tab under payment window
	  */
	public void setallocateType (String allocateType)
	{

		set_Value (COLUMNNAME_allocateType, allocateType);
	}

	/** Get AllocateType.
		@return This is new field to apply charges and invoice at allocate tab under payment window
	  */
	public String getallocateType () 
	{
		return (String)get_Value(COLUMNNAME_allocateType);
	}
}